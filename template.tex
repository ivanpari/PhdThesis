...
\newcommand{\Titledutch}{``Een zoektocht naar smaakveranderende neutrale stromen gerelateerd met een top quark en een Z boson, gebruik makend van de data gecollecteerd door het CMS experiment met een massamiddelpuntsmassaenergie van 13 TeV.''}
...
\newcommand{\dateHandIn}{13~November~2017}
\newcommand{\dateDefense}{21~December~2017}
...
\label{chap:4}
\input{4_EventRecoSelect/eventrecoandselection.tex}
\chapter{Event selection and categorisation}
\label{chap:5}
\input{5_EventSelection/eventselection.tex}
\chapter{The search for FCNC involving a top quark and a Z boson}
\label{chap:6}
\input{6_Search/search.tex}
\begin{comment}
...
\input{_titleachievement.tex}
\cleardoublepage\thispagestyle{empty}
\input{_achievement.tex}

\input{_titlesummary.tex}

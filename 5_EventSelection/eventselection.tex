...
\begin{figure}[tbph]
	\centering
	\includegraphics[width=0.49\linewidth]{5_EventSelection/Figures/placeholder}
	\includegraphics[width=0.49\linewidth]{5_EventSelection/Figures/placeholder}

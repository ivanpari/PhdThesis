...
\documentclass[
  11pt, a4paper,        % font and paper size change to  b5paper http://texdoc.net/texmf-dist/doc/latex/memoir/memman.pdf
  fleqn,                % align equations to the left %https://tex.stackexchange.com/questions/185276/go-from-b5-to-a4-format
...
%  \usepackage{layout}                            % (encoding which is used for saving)
\usepackage[TS1,T1]{fontenc}  % Output-Encoding
                              % (Latin1 [T1] with additional sepecial characters [TS1])
\usepackage{collcell}
% \usepackage[dutch]{babel}   % German language package
\usepackage[dutch,english]{babel}   % English language package
\usepackage{array}
...
\setlength{\epigraphrule}{0.pt}
 \renewcommand{\sourceflush}{flushright}
%\usepackage{bbold}  % for unitarity symbol
\usepackage[makeroom]{cancel}  % strikout text for EW symmetry breaking
% references

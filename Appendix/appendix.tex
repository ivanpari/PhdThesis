...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_SMtop_Eta_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_mlb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiWlepb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiZWlep_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_charge_asym_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_bdiscCSVv2_jet_0_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_TotalHt_lep_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_ptWQ_uuu_Normalized}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \STSR\ for the \Zut\ vertex for the \mumumu\ lepton channel. The contribution of the \NPL\ background is not included. }
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_SMtop_Eta_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_mlb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiWlepb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiZWlep_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_uue_Normalized}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_SMtop_Eta_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_mlb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiWlepb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiZWlep_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_eeu_Normalized}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_SMtop_Eta_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_mlb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiWlepb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dPhiZWlep_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/singletop_MVA_dRWlepb_eee_Normalized}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_SMtop_Eta_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_mlb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiWlepb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_deltaRWlepJet_min_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_Zboson_M_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiZWlep_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRWlepb_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_NJets_CSVv2M_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_FCNCtop_M_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRZc_uuu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRSMjetLightjet_uuu_Normalized}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zut\ vertex. For the \mumumu\ lepton channel.}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_SMtop_Eta_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_mlb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiWlepb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_deltaRWlepJet_min_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_Zboson_M_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiZWlep_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRWlepb_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_NJets_CSVv2M_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_FCNCtop_M_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRZc_uue_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRSMjetLightjet_uue_Normalized}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zut\ vertex. For the \emumu\ lepton channel.}
	\label{fig:toppairZutnormalizeduue}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_SMtop_Eta_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_mlb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiWlepb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_deltaRWlepJet_min_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_Zboson_M_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiZWlep_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRWlepb_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_NJets_CSVv2M_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_FCNCtop_M_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRZc_eeu_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRSMjetLightjet_eeu_Normalized}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zut\ vertex. For the \eemu\ lepton channel.}
	\label{fig:toppairZutnormalizedeeu}
\end{figure}
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_SMtop_Eta_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_mlb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiWlepb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_deltaRWlepJet_min_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_Zboson_M_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dPhiZWlep_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRWlepb_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_NJets_CSVv2M_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_FCNCtop_M_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRZc_eee_Normalized}
	\includegraphics[width=0.3\linewidth]{6_Search/Figures/BDTinputvars/Zut/toppair_MVA_dRSMjetLightjet_eee_Normalized}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zut\ vertex. For the \eee\ lepton channel.}
...
\begin{figure}[htbp]
	...
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zut\ vertex.}
...
\begin{figure}[htbp]
	...
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \STSR\ for the \Zut\ vertex.}
...
%	\includegraphics[width=0.25\linewidth]{6_Search/Figures/BDTinputvars/Zct/Stack/toppair_MVA_dRZb_all_Stack}
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \TTSR\ for the \Zct\ vertex.}
...
%	\includegraphics[width=0.25\linewidth]{6_Search/Figures/BDTinputvars/Zct/Stack/singletop_MVA_dRZWlep_all_Stack}   
	\caption{The normalised distributions of the input variables for reconstructing the multivariate discriminator in the \STSR\ for the \Zct\ vertex.}

...
\subsection{Jets}
Jets are reconstructed using either all reconstructed particles (PF jets) or from all reconstructed particles without the charged hadrons associated to pile up vertices (PF+CHS jets). This recontruction is done via the \antikt\ algorithm \todocite with a radius parameter of 0.5.  Based on the clustering used by this algorithm, the jets are denoted as
\begin{enumerate}

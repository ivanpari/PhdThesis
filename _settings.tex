...
%\setlength{\textwidth}{125.2mm}       % width of the text area
%%\setlength{\textheight}{220mm}      % height of the text area
%\setlength{\textheight}{180mm}      % height of the text area
%\setlength{\hoffset}{0pt}           % offset insertet at the left
%
%%\setlength{\voffset}{10pt}          % offset inserted at the top
%\setlength{\voffset}{5pt}          % offset inserted at the top
%%\setlength{\topmargin}{0pt}          % offset inserted at the top
%\setlength{\oddsidemargin}{80mm}     % offset inserted to the left for odd pages
%\setlength{\evensidemargin}{-50mm}    % offset inserted to the left for even pages
%%\setlength{\marginparwidth}{18mm}   % width for marginal notes (Randnotizen)
%\setlength{\marginparwidth}{5mm}   % width for marginal notes (Randnotizen)
%
...
\makechapterstyle{jenor}{
  ...
  \renewcommand\printchaptertitle[1]{%
    ...
    \begin{tabularx}{\textwidth}{X}%
      ...
      \vphantom{\raisebox{-20pt}{\chapnumfont 1}}}
    \end{tabularx}%
    \else
    \begin{tabularx}{\textwidth}{Xl}
      {\parbox[b]{\linewidth}{\chaptitlefont ##1}}
      & \raisebox{-20pt}{\chapnumfont\ \thechapter}%
    \end{tabularx}%
    \fi
    \par\vskip2mm\hrule
  }
...
\presetkeys{todonotes}{backgroundcolor=gray75, bordercolor=orange,
prepend, caption={\textbf{\textcolor{red}{NOTE}}}}{}

...
\begin{figure}[ht]
	\centering
	  \includegraphics[width=0.39\linewidth]{6_Search/Figures/BDTunweighted/toppair_Zut_BDT_eee_Stack}
	  \includegraphics[width=0.39\linewidth]{6_Search/Figures/BDTunweighted/toppair_Zct_BDT_eee_Stack}
	  \includegraphics[width=0.39\linewidth]{6_Search/Figures/BDTunweighted/singletop_Zut_BDT_eee_Stack}
	  \includegraphics[width=0.39\linewidth]{6_Search/Figures/BDTunweighted/singletop_Zct_BDT_eee_Stack}
...
\begin{figure}[htbp] 
	...
	\subbottom[Pileup uncertainty]{
	    \includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_puSF_nom_bkg}
    }
    \subbottom[Electron identification  uncertainty]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_electronSF_nom_bkg}
    }
    \subbottom[Muon identification uncertainty]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_muonSF_nom_bkg}
    }
	\subbottom[Jet energy scale uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_JES_nom_bkg}
	}
	\subbottom[Jet energy resolution uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_JER_nom_bkg}
	}
	\subbottom[CSVv2: cf uncertainty~(1)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_cferr1_nom_bkg}
	}
    \subbottom[CSVv2: cf uncertainty~(2)]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_cferr2_nom_bkg}
    }
    \subbottom[CSVv2: hf uncertainty]{
     	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_hf_nom_bkg}
    }
    \subbottom[CSVv2: lf uncertainty ]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_lf_nom_bkg}
    }
    \subbottom[CSVv2: hf statistical uncertainty~(1) ]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_hfstats1_nom_bkg}
    }
    \subbottom[CSVv2: hf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_hfstats2_nom_bkg}
    }
    \subbottom[CSVv2: lf statistical uncertainty~(1) ]{
    	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_lfstats1_nom_bkg}
    }
    \subbottom[CSVv2: lf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/MTWsys/hist_mWt_btagSF_lfstats2_nom_bkg}
	}
...
\begin{figure}[htbp] 
	\centering 
	\subbottom[Pileup uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_puSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_puSF_nom_sig}
	}
	\subbottom[Electron identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_electronSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_electronSF_nom_sig}
	}
	\subbottom[Muon identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_muonSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_muonSF_nom_sig}
	}
	\subbottom[Jet energy scale uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_JES_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_JES_nom_sig}
	}
	\subbottom[Jet energy resolution uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_JER_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_JER_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(1)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_cferr1_nom_bkg}
         	\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_cferr1_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(2)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_cferr2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_cferr2_nom_sig}
	}
	\subbottom[CSVv2: hf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hf_nom_bkg}
			\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hf_nom_sig}
	}
	\subbottom[CSVv2: lf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lf_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hfstats1_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_hfstats2_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lfstats1_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzct/systematics/hist_BDT_btagSF_lfstats2_nom_sig}
	}
	\caption{Distribution of the nominal values and shift due to systematic uncertainties for the transverse mass of the \PW\ boson in the \STSR\ for the \WZ\ process and FCNC signal involving a \Zct\ vertex. All leptonic channels summed.}
...
\begin{figure}[htbp] 
	\centering 
	\subbottom[Pileup uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_puSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_puSF_nom_sig}
	}
	\subbottom[Electron identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_electronSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_electronSF_nom_sig}
	}
	\subbottom[Muon identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_muonSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_muonSF_nom_sig}
	}
	\subbottom[Jet energy scale uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_JES_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_JES_nom_sig}
	}
	\subbottom[Jet energy resolution uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_JER_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_JER_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(1)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_cferr1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_cferr1_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(2)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_cferr2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_cferr2_nom_sig}
	}
	\subbottom[CSVv2: hf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hf_nom_sig}
	}
	\subbottom[CSVv2: lf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lf_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hfstats1_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_hfstats2_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lfstats1_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzct/systematics/hist_BDT_btagSF_lfstats2_nom_sig}
	}
	\caption{Distribution of the nominal values and shift due to systematic uncertainties for the transverse mass of the \PW\ boson in the \TTSR\ for the \WZ\ process and FCNC signal involving a \Zct\ vertex. All leptonic channels summed.}
...
\begin{figure}[htbp] 
	\centering 
	\subbottom[Pileup uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_puSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_puSF_nom_sig}
	}
	\subbottom[Electron identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_electronSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_electronSF_nom_sig}
	}
	\subbottom[Muon identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_muonSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_muonSF_nom_sig}
	}
	\subbottom[Jet energy scale uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_JES_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_JES_nom_sig}
	}
	\subbottom[Jet energy resolution uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_JER_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_JER_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(1)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_cferr1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_cferr1_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(2)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_cferr2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_cferr2_nom_sig}
	}
	\subbottom[CSVv2: hf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hf_nom_sig}
	}
	\subbottom[CSVv2: lf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lf_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hfstats1_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_hfstats2_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lfstats1_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/singletopzut/systematics/hist_BDT_btagSF_lfstats2_nom_sig}
	}
	\caption{Distribution of the nominal values and shift due to systematic uncertainties for the transverse mass of the \PW\ boson in the \STSR\ for the \WZ\ process and FCNC signal involving a \Zut\ vertex. All leptonic channels summed.}
...
\begin{figure}[htbp] 
	\centering 
	\subbottom[Pileup uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_puSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_puSF_nom_sig}
	}
	\subbottom[Electron identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_electronSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_electronSF_nom_sig}
	}
	\subbottom[Muon identification uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_muonSF_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_muonSF_nom_sig}
	}
	\subbottom[Jet energy scale uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_JES_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_JES_nom_sig}
	}
	\subbottom[Jet energy resolution uncertainty]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_JER_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_JER_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(1)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_cferr1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_cferr1_nom_sig}
	}
	\subbottom[CSVv2: cf uncertainty~(2)]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_cferr2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_cferr2_nom_sig}
	}
	\subbottom[CSVv2: hf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hf_nom_sig}
	}
	\subbottom[CSVv2: lf uncertainty ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lf_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lf_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hfstats1_nom_sig}
	}
	\subbottom[CSVv2: hf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_hfstats2_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(1) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lfstats1_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lfstats1_nom_sig}
	}
	\subbottom[CSVv2: lf statistical uncertainty~(2) ]{
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lfstats2_nom_bkg}
		\includegraphics[width=0.23\linewidth]{6_Search/Figures/SystematicEffect/toppairzut/systematics/hist_BDT_btagSF_lfstats2_nom_sig}
	}
	\caption{Distribution of the nominal values and shift due to systematic uncertainties for the transverse mass of the \PW\ boson in the \TTSR\ for the \WZ\ process and FCNC signal involving a \Zut\ vertex. All leptonic channels summed.}
...
\begin{comment}
%\begin{figure}[htbp]
%	\centering \begin{minipage}{0.45\linewidth} \centering
